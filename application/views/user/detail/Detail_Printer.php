<div class="container">
    <?php foreach ($isiP as $row) { ?>
        <div class="row mt-lg-5" style="margin-bottom: 8rem;">
            <div class="col-sm-6">
                <img src="<?php echo base_url('assets/img/printer/' . $row->gambar) ?>" class="card-img-top shadow-lg"></a>
            </div>
            <div class="col-sm-6">
                <form action="<?php echo site_url('CTR_Pelanggan/MasukanKeranjang') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <a href="#BuyPrinter<?php echo $id_barang ?>" data-toggle="modal" data-target="#BuyPrinter<?php echo $id_barang ?>" class="btn text-white" style="background-color: #0099cc;">Beli Sekarang </a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- Modal Buy Now -->
<?php foreach ($isiP as $row) { ?>
    <div class="modal fade" id="BuyPrinter<?php echo $id_barang ?>" tabindex="-1" aria-labelledby="BuyPrinter<?php echo $id_barang ?>Label" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" readonly type="text" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $user['username'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label class="form-label">No Telephone</label>
                                                <input class="form-control" readonly type="text" name="no_telp" placeholder="No Telephone" value="<?php echo $user['no_telp'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <!-- <label class="control-label text-danger float-right" style="font-size: 10px;">*Biaya pengiriman Rp. 12.000</label> -->
                                            <div class="form-group">
