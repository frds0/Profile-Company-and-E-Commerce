<div class="container">
    <?php foreach ($isiK as $row) { ?>
        <div class="row mt-lg-5" style="margin-bottom: 8rem;">
            <div class="col-sm-6">
                <img src="<?php echo base_url('assets/img/barang/' . $row->gambar) ?>" class="card-img-top shadow-lg" alt="SDHC"></a>
            </div>
            <div class="col-sm-6">
                <form action="<?php echo site_url('CTR_Pelanggan/MasukanKeranjang') ?>" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <a href="#BuyKomputer<?php echo $id_barang ?>" data-toggle="modal" data-target="#BuyKomputer<?php echo $id_barang ?>" class="btn text-white" style="background-color: #0099cc;">Beli Sekarang </a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- Modal Buy Now -->
<?php foreach ($isiK as $row) { ?>
    <div class="modal fade" id="BuyKomputer<?php echo $id_barang ?>" tabindex="-1" aria-labelledby="BuyKomputer<?php echo $id_barang ?>Label" aria-hidden="true">
